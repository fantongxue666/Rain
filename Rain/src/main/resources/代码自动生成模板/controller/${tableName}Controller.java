...
public class ${tableName?cap_first}Controller {
    ...
    @PostMapping("/getById")
    public JsonObject<Object> toEdit${tableName?cap_first}(${table[0].columnType} ${table[0].columnName}){
    ...
    @PostMapping("/delById")
    public JsonObject<Object> delete${tableName?cap_first}(${table[0].columnType} ${table[0].columnName}){
        int i = ${tableName}Service.delete${tableName?cap_first}(${table[0].columnName});
        return i>0?JsonObject.Success():JsonObject.Error();
    }
